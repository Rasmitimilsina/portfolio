...
`)+`
`+S);const b=_+p+s,C=_+S+o,T=Th(n,n.VERTEX_SHADER,b),w=Th(n,n.FRAGMENT_SHADER,C);n.attachShader(f,T),n.attachShader(f,w),t.index0AttributeName!==void 0?n.bindAttribLocation(f,0,t.index0AttributeName):t.morphTargets===!0&&n.bindAttribLocation(f,0,"position"),n.linkProgram(f);function P(K){if(i.debug.checkShaderErrors){const Y=n.getProgramInfoLog(f).trim(),L=n.getShaderInfoLog(T).trim(),V=n.getShaderInfoLog(w).trim();let F=!0,H=!0;if(n.getProgramParameter(f,n.LINK_STATUS)===!1)if(F=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(n,f,T,w);else{const X=wh(n,T,"vertex"),A=wh(n,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+n.getError()+" - VALIDATE_STATUS "+n.getProgramParameter(f,n.VALIDATE_STATUS)+`
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Xt,_o,Pi,kr,Gr,ya,nf,_n,Sa,af,Er,Ji,sf,of=function(){return Xt||typeof window<"u"&&(Xt=window.gsap)&&Xt.registerPlugin&&Xt},lf=1,ma=[],tt=[],lr=[],as=Date.now,yc=function(i,e){return e},Ty=function(){var i=Sa.core,e=i.bridge||{},t=i._scrollers,r=i._proxies;t.push.apply(t,tt),r.push.apply(r,lr),tt=t,lr=r,yc=function(n,a){return e[n](a)}},qr=function(i,e){return~lr.indexOf(i)&&lr[lr.indexOf(i)+1][e]},ss=function(i){return!!~af.indexOf(i)},ri=function(i,e,t,r,n){return i.addEventListener(e,t,{passive:r!==!1,capture:!!n})},ii=function(i,e,t,r){return i.removeEventListener(e,t,!!r)},eo="scrollLeft",to="scrollTop",Sc=function(){return Er&&Er.isPressed||tt.cache++},No=function(i,e){var t=function r(n){if(n||n===0){lf&&(Pi.history.scrollRestoration="manual");var a=Er&&Er.isPressed;n=r.v=Math.round(n)||(Er&&Er.iOS?1:0),i(n),r.cacheID=tt.cache,a&&yc("ss",n)}else(e||tt.cache!==r.cacheID||yc("ref"))&&(r.cacheID=tt.cache,r.v=i());return r.v+r.offset};return t.offset=0,i&&t},ui={s:eo,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:No(function(i){return arguments.length?Pi.scrollTo(i,Ot.sc()):Pi.pageXOffset||kr[eo]||Gr[eo]||ya[eo]||0})},Ot={s:to,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:ui,sc:No(function(i){return arguments.length?Pi.scrollTo(ui.sc(),i):Pi.pageYOffset||kr[to]||Gr[to]||ya[to]||0})},fi=function(i,e){return(e&&e._ctx&&e._ctx.selector||Xt.utils.toArray)(i)[0]||(typeof i=="string"&&Xt.config().nullTargetWarn!==!1?console.warn("Element not found:",i):null)},wy=function(i,e){for(var t=e.length;t--;)if(e[t]===i||e[t].contains(i))return!0;return!1},en=function(i,e){var t=e.s,r=e.sc;ss(i)&&(i=kr.scrollingElement||Gr);var n=tt.indexOf(i),a=r===Ot.sc?1:2;!~n&&(n=tt.push(i)-1),tt[n+a]||ri(i,"scroll",Sc);var s=tt[n+a],o=s||(tt[n+a]=No(qr(i,t),!0)||(ss(i)?r:No(function(l){return arguments.length?i[t]=l:i[t]})));return o.target=i,s||(o.smooth=Xt.getProperty(i,"scrollBehavior")==="smooth"),o},Ec=function(i,e,t){var r=i,n=i,a=as(),s=a,o=e||50,l=Math.max(500,o*3),c=function(h,m){var g=as();m||g-a>o?(n=r,r=h,s=a,a=g):t?r+=h:r=n+(h-n)/(g-s)*(a-s)},u=function(){n=r=t?0:r,s=a=0},d=function(h){var m=s,g=n,v=as();return(h||h===0)&&h!==r&&c(h),a===s||v-s>l?0:(r+(t?g:-g))/((t?v:a)-m)*1e3};return{update:c,reset:u,getVelocity:d}},ja=function(i,e){return e&&!i._gsapAllow&&i.cancelable!==!1&&i.preventDefault(),i.changedTouches?i.changedTouches[0]:i},od=function(i){var e=Math.max.apply(Math,i),t=Math.min.apply(Math,i);return Math.abs(e)>=Math.abs(t)?e:t},cf=function(){Sa=Xt.core.globals().ScrollTrigger,Sa&&Sa.core&&Ty()},uf=function(i){return Xt=i||of(),!_o&&Xt&&typeof document<"u"&&document.body&&(Pi=window,kr=document,Gr=kr.documentElement,ya=kr.body,af=[Pi,kr,Gr,ya],Xt.utils.clamp,sf=Xt.core.context||function(){},_n="onpointerenter"in ya?"pointer":"mouse",nf=Lt.isTouch=Pi.matchMedia&&Pi.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Pi||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,Ji=Lt.eventTypes=("ontouchstart"in Gr?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in Gr?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return lf=0},500),_o=1),Sa||cf(),_o};ui.op=Ot;tt.cache=0;var Lt=function(){function i(t){this.init(t)}var e=i.prototype;return e.init=function(t){_o||uf(Xt)||console.warn("Please gsap.registerPlugin(Observer)"),Sa||cf();var r=t.tolerance,n=t.dragMinimum,a=t.type,s=t.target,o=t.lineHeight,l=t.debounce,c=t.preventDefault,u=t.onStop,d=t.onStopDelay,h=t.ignore,m=t.wheelSpeed,g=t.event,v=t.onDragStart,f=t.onDragEnd,p=t.onDrag,S=t.onPress,_=t.onRelease,b=t.onRight,C=t.onLeft,T=t.onUp,w=t.onDown,P=t.onChangeX,U=t.onChangeY,x=t.onChange,y=t.onToggleX,K=t.onToggleY,Y=t.onHover,L=t.onHoverEnd,V=t.onMove,F=t.ignoreCheck,H=t.isNormalizer,X=t.onGestureStart,A=t.onGestureEnd,$=t.onWheel,ie=t.onEnable,pe=t.onDisable,fe=t.onClick,W=t.scrollSpeed,ee=t.capture,se=t.allowClicks,we=t.lockAxis,ge=t.onLockAxis;this.target=s=fi(s)||Gr,this.vars=t,h&&(h=Xt.utils.toArray(h)),r=r||1e-9,n=n||0,m=m||1,W=W||1,a=a||"wheel,touch,pointer",l=l!==!1,o||(o=parseFloat(Pi.getComputedStyle(ya).lineHeight)||22);var _e,He,Ae,I,$e,ve,De,N=this,Oe=0,Ue=0,ze=t.passive||!c&&t.passive!==!1,ke=en(s,ui),R=en(s,Ot),M=ke(),q=R(),Z=~a.indexOf("touch")&&!~a.indexOf("pointer")&&Ji[0]==="pointerdown",te=ss(s),J=s.ownerDocument||kr,Ie=[0,0,0],Re=[0,0,0],ne=0,he=function(){return ne=as()},Te=function(Q,Fe){return(N.event=Q)&&h&&wy(Q.target,h)||Fe&&Z&&Q.pointerType!=="touch"||F&&F(Q,Fe)},oe=function(){N._vx.reset(),N._vy.reset(),He.pause(),u&&u(N)},ot=function(){var Q=N.deltaX=od(Ie),Fe=N.deltaY=od(Re),st=Math.abs(Q)>=r,re=Math.abs(Fe)>=r;x&&(st||re)&&x(N,Q,Fe,Ie,Re),st&&(b&&N.deltaX>0&&b(N),C&&N.deltaX<0&&C(N),P&&P(N),y&&N.deltaX<0!=Oe<0&&y(N),Oe=N.deltaX,Ie[0]=Ie[1]=Ie[2]=0),re&&(w&&N.deltaY>0&&w(N),T&&N.deltaY<0&&T(N),U&&U(N),K&&N.deltaY<0!=Ue<0&&K(N),Ue=N.deltaY,Re[0]=Re[1]=Re[2]=0),(I||Ae)&&(V&&V(N),Ae&&(v&&Ae===1&&v(N),p&&p(N),Ae=0),I=!1),ve&&!(ve=!1)&&ge&&ge(N),$e&&($(N),$e=!1),_e=0},Ge=function(Q,Fe,st){Ie[st]+=Q,Re[st]+=Fe,N._vx.update(Q),N._vy.update(Fe),l?_e||(_e=requestAnimationFrame(ot)):ot()},Ce=function(Q,Fe){we&&!De&&(N.axis=De=Math.abs(Q)>Math.abs(Fe)?"x":"y",ve=!0),De!=="y"&&(Ie[2]+=Q,N._vx.update(Q,!0)),De!=="x"&&(Re[2]+=Fe,N._vy.update(Fe,!0)),l?_e||(_e=requestAnimationFrame(ot)):ot()},xe=function(Q){if(!Te(Q,1)){Q=ja(Q,c);var Fe=Q.clientX,st=Q.clientY,re=Fe-N.x,Pe=st-N.y,be=N.isDragging;N.x=Fe,N.y=st,(be||(re||Pe)&&(Math.abs(N.startX-Fe)>=n||Math.abs(N.startY-st)>=n))&&(Ae||(Ae=be?2:1),be||(N.isDragging=!0),Ce(re,Pe))}},Ee=N.onPress=function(Q){Te(Q,1)||Q&&Q.button||(N.axis=De=null,He.pause(),N.isPressed=!0,Q=ja(Q),Oe=Ue=0,N.startX=N.x=Q.clientX,N.startY=N.y=Q.clientY,N._vx.reset(),N._vy.reset(),ri(H?s:J,Ji[1],xe,ze,!0),N.deltaX=N.deltaY=0,S&&S(N))},me=N.onRelease=function(Q){if(!Te(Q,1)){ii(H?s:J,Ji[1],xe,!0);var Fe=!isNaN(N.y-N.startY),st=N.isDragging,re=st&&(Math.abs(N.x-N.startX)>3||Math.abs(N.y-N.startY)>3),Pe=ja(Q);!re&&Fe&&(N._vx.reset(),N._vy.reset(),c&&se&&Xt.delayedCall(.08,function(){if(as()-ne>300&&!Q.defaultPrevented){if(Q.target.click)Q.target.click();else if(J.createEvent){var be=J.createEvent("MouseEvents");be.initMouseEvent("click",!0,!0,Pi,1,Pe.screenX,Pe.screenY,Pe.clientX,Pe.clientY,!1,!1,!1,!1,0,null),Q.target.dispatchEvent(be)}}})),N.isDragging=N.isGesturing=N.isPressed=!1,u&&st&&!H&&He.restart(!0),Ae&&ot(),f&&st&&f(N),_&&_(N,re)}},Ne=function(Q){return Q.touches&&Q.touches.length>1&&(N.isGesturing=!0)&&X(Q,N.isDragging)},it=function(){return(N.isGesturing=!1)||A(N)},D=function(Q){if(!Te(Q)){var Fe=ke(),st=R();Ge((Fe-M)*W,(st-q)*W,1),M=Fe,q=st,u&&He.restart(!0)}},le=function(Q){if(!Te(Q)){Q=ja(Q,c),$&&($e=!0);var Fe=(Q.deltaMode===1?o:Q.deltaMode===2?Pi.innerHeight:1)*m;Ge(Q.deltaX*Fe,Q.deltaY*Fe,0),u&&!H&&He.restart(!0)}},G=function(Q){if(!Te(Q)){var Fe=Q.clientX,st=Q.clientY,re=Fe-N.x,Pe=st-N.y;N.x=Fe,N.y=st,I=!0,u&&He.restart(!0),(re||Pe)&&Ce(re,Pe)}},ce=function(Q){N.event=Q,Y(N)},ae=function(Q){N.event=Q,L(N)},nt=function(Q){return Te(Q)||ja(Q,c)&&fe(N)};He=N._dc=Xt.delayedCall(d||.25,oe).pause(),N.deltaX=N.deltaY=0,N._vx=Ec(0,50,!0),N._vy=Ec(0,50,!0),N.scrollX=ke,N.scrollY=R,N.isDragging=N.isGesturing=N.isPressed=!1,sf(this),N.enable=function(Q){return N.isEnabled||(ri(te?J:s,"scroll",Sc),a.indexOf("scroll")>=0&&ri(te?J:s,"scroll",D,ze,ee),a.indexOf("wheel")>=0&&ri(s,"wheel",le,ze,ee),(a.indexOf("touch")>=0&&nf||a.indexOf("pointer")>=0)&&(ri(s,Ji[0],Ee,ze,ee),ri(J,Ji[2],me),ri(J,Ji[3],me),se&&ri(s,"click",he,!0,!0),fe&&ri(s,"click",nt),X&&ri(J,"gesturestart",Ne),A&&ri(J,"gestureend",it),Y&&ri(s,_n+"enter",ce),L&&ri(s,_n+"leave",ae),V&&ri(s,_n+"move",G)),N.isEnabled=!0,N.isDragging=N.isGesturing=N.isPressed=I=Ae=!1,N._vx.reset(),N._vy.reset(),M=ke(),q=R(),Q&&Q.type&&Ee(Q),ie&&ie(N)),N},N.disable=function(){N.isEnabled&&(ma.filter(function(Q){return Q!==N&&ss(Q.target)}).length||ii(te?J:s,"scroll",Sc),N.isPressed&&(N._vx.reset(),N._vy.reset(),ii(H?s:J,Ji[1],xe,!0)),ii(te?J:s,"scroll",D,ee),ii(s,"wheel",le,ee),ii(s,Ji[0],Ee,ee),ii(J,Ji[2],me),ii(J,Ji[3],me),ii(s,"click",he,!0),ii(s,"click",nt),ii(J,"gesturestart",Ne),ii(J,"gestureend",it),ii(s,_n+"enter",ce),ii(s,_n+"leave",ae),ii(s,_n+"move",G),N.isEnabled=N.isPressed=N.isDragging=!1,pe&&pe(N))},N.kill=N.revert=function(){N.disable();var Q=ma.indexOf(N);Q>=0&&ma.splice(Q,1),Er===N&&(Er=0)},ma.push(N),H&&ss(s)&&(Er=N),N.enable(g)},by(i,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),i}();Lt.version="3.15.0";Lt.create=function(i){return new Lt(i)};Lt.register=uf;Lt.getAll=function(){return ma.slice()};Lt.getById=function(i){return ma.filter(function(e){return e.vars.id===i})[0]};of()&&Xt.registerPlugin(Lt);/*!
